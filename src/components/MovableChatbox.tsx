      ...
      >
        ...
        {isOpen && (
          <motion.div
            ...
            className={`pointer-events-auto fixed bottom-24 right-6 w-[320px] bg-slate-900 border border-slate-700/80 rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.4)] overflow-hidden flex flex-col select-none z-[9999] ${isMinimized ? "" : "backdrop-blur-md"}`}
          >
            {/* Header / Grab Bar */}
            <div className={`border-b border-slate-800 px-3 py-2 flex items-center justify-between cursor-grab active:cursor-grabbing shrink-0 select-none ${isMinimized ? "bg-slate-950" : "bg-slate-950/80"}`}>
